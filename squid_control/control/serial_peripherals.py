...
class XLight:
    ...
    def set_emission_filter(self, position, extraction=False):
        ...
        current_pos = self.serial_connection.write_and_check(
            "B" + position_to_write + "\r", "B" + position_to_read
        )
    ...
    def set_dichroic(self, position, extraction=False):
        ...
        current_pos = self.serial_connection.write_and_check(
            "C" + position_to_write + "\r", "C" + position_to_read
        )
    ...
    def set_disk_position(self, position):
        ...
        current_pos = self.serial_connection.write_and_check(
            "D" + position_to_write + "\r", "D" + position_to_read
        )
    ...
    def set_disk_motor_state(self, state):
        ...
        current_pos = self.serial_connection.write_and_check(
            "N" + state_to_write + "\r", "N" + state_to_write
        )
