...
class OctopiGUI(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.liveControlWidget_1 = widgets.LiveControlWidget(
            self.streamHandler_1, self.liveController_1, self.configurationManager_1
        )
        ...
        self.liveControlWidget_2 = widgets.LiveControlWidget(
            self.streamHandler_2, self.liveController_2, self.configurationManager_2
        )
