...
class ImageEventHandler(PySpin.ImageEventHandler):
    ...
    def OnImageEvent(self, raw_image):
        ...
        if self.camera.trigger_mode == TriggerModeSetting.HARDWARE:
...
class Camera(object):
    ...
    def set_continuous_acquisition(self):
        ...
        node_trigger_mode = PySpin.CEnumerationPtr(
            self.nodemap.GetNode("CONFIG.TriggerMode")
        )
        ...
        if not PySpin.IsWritable(node_trigger_mode) or not PySpin.IsReadable(
            ...
            print("Cannot toggle CONFIG.TriggerMode")
            return
