...
def malaria_rtp(I_fluorescence, I_left, I_right, i, j, k, multiPointWorker,classification_test_mode=False,sort_during_multipoint=True,disp_th_during_multipoint=0.95):
    ...
    processing_kwargs = {'upload_fn':default_upload_fn,
                        ...
                        'sort':sort_during_multipoint,
                        'disp_th':disp_th_during_multipoint,
                        'i':i, 'j':j, 'k':k}
