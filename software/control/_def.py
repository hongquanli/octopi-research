...
MAX_VELOCITY_Z_mm = 2
MAX_VELOCITY_W_mm = 3.19 * SCREW_PITCH_W_MM

MAX_ACCELERATION_X_mm = 500
MAX_ACCELERATION_Y_mm = 500
MAX_ACCELERATION_Z_mm = 20
MAX_ACCELERATION_W_mm = 300 * SCREW_PITCH_W_MM
...
USE_SQUID_FILTERWHEEL = True
SQUID_FILTERWHEEL_MAX_INDEX = 7
SQUID_FILTERWHEEL_MIN_INDEX = 0
SQUID_FILTERWHEEL_OFFSET = SCREW_PITCH_W_MM / 100.0
