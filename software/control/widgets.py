...
class CameraSettingsWidget(QFrame):
    ...
    def add_components(self):
        ...
        self.entry_exposureTime.setMaximum(1000) 
        self.entry_exposureTime.setSingleStep(5)
        self.entry_exposureTime.setValue(20)
        self.camera.set_exposure_time(20)

        self.entry_analogGain = QDoubleSpinBox()
        self.entry_analogGain.setMinimum(0) 
        self.entry_analogGain.setMaximum(50) 
        ...
        self.entry_exposureTimeBFPreset.setMinimum(0.01) 
        self.entry_exposureTimeBFPreset.setMaximum(1000) 
        self.entry_exposureTimeBFPreset.setSingleStep(5)
        ...
        self.entry_analogGainBFPreset.setMinimum(0) 
        self.entry_analogGainBFPreset.setMaximum(50) 
        self.entry_analogGainBFPreset.setSingleStep(1)
        ...
        self.entry_exposureTimeFLPreset.setMinimum(0.01) 
        self.entry_exposureTimeFLPreset.setMaximum(1000) 
        self.entry_exposureTimeFLPreset.setSingleStep(5)
        ...
        self.entry_analogGainFLPreset.setMinimum(0) 
        self.entry_analogGainFLPreset.setMaximum(50) 
        self.entry_analogGainFLPreset.setSingleStep(1)
        ...
        self.entry_exposureTimeFLPreviewPreset.setMinimum(0.01) 
        self.entry_exposureTimeFLPreviewPreset.setMaximum(1000) 
        self.entry_exposureTimeFLPreviewPreset.setSingleStep(5)
        ...
        self.entry_analogGainFLPreviewPreset.setMinimum(0) 
        self.entry_analogGainFLPreviewPreset.setMaximum(50) 
        self.entry_analogGainFLPreviewPreset.setSingleStep(1)
...
class MultiPointWidget(QFrame):
    ...
    def add_components(self):
        ...
        self.entry_Nt.setMaximum(1)   # @@@ to be changed
