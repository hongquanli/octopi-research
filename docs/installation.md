# Squid Control Installation Guide

## Setting up the environments for Ubuntu 22.04
...
## Development
To install the development environment, run the following script in terminal

```
conda create -n squid-control python=3.10 -y
conda activate squid-control
